...
const Hero = () => {
  return (
    <section className="flex min-h-[700px]  w-full items-center justify-center bg-transparent text-white px-8">
    <div className="flex w-full max-w-6xl gap-10 lg:flex-row flex-col items-center justify-between">
      <div className="max-w-md md:space-y-6 sm:space-y-5 space-y-4">
        <h1 className="lg:text-5xl sm:text-4xl text-3xl font-bold leading-tight text-gray-900">Coxs bazar</h1>
